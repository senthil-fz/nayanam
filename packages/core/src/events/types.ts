/**
 * Canonical event type registry. Every domain mutation that emits an audit
 * event MUST use one of these constants instead of a raw string literal.
 * This guarantees the event type set is discoverable from one place.
 */
