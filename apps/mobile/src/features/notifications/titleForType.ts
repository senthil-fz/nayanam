...
//
// Kept in-app (not `packages/core`) because the title strings are UX copy and
// may diverge per platform (e.g. mobile truncation budgets, voice-over tone).
// De-dup candidate: if web + mobile copy stays lock-step for a while, lift
// into `packages/core/src/notifications/titles.ts`.
